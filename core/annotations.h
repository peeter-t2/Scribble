...
class ThematicTagAnnotationPrivate;
...
class OKULAR_EXPORT Annotation
{
    ...
    public:
        ...
        enum SubType
        {
            ...
            AThematicTag = 15,   ///< A thematic tag annotation
        ...
        /**
         * Sets the @p thematictags of the annotation.
         */
        void setThematicTags( const QString &thematictags );

        /**
         * Returns the thematictags of the annotation.
         */
...
class OKULAR_EXPORT ThematicTagAnnotation : public Annotation
{
    public:
        /**
         * Describes the highlighting style of the annotation.
         */
        enum ThematicTagType
        {
            Highlight,  ///< Highlights the text
            Squiggly,   ///< Squiggles the text
            Underline,  ///< Underlines the text
         ...
         * Creates a new highlight annotation.
         */
        ThematicTagAnnotation();

        /**
         * Creates a new highlight annotation from the xml @p description
         */
        explicit ThematicTagAnnotation( const QDomNode &description );
         ...
         * @see HighlightType
         */
        void setThematicTagType( ThematicTagType type );

        /**
         * Returns the type of the highlight annotation.
         */
        ThematicTagType ThematicTagType() const;
    ...
    private:
        Q_DECLARE_PRIVATE( ThematicTagAnnotation )
        Q_DISABLE_COPY( ThematicTagAnnotation )
};
